  ...
  return (
    <header className={styles.header}>
      <div className={styles.container}>
        <Link href='/'>
          <img width={"140"} alt="logo" src="/logo.png"></img>
        </Link>
        <section onClick={() => dispatch(setIsCategClicked())} className={`${styles.centerFlex} ${styles.categoryBtn}`}>
          <span>Категорії</span>  
          <svg
          ...
          <Paper elevation={3} style={!isCategoriesClicked ? {visibility: 'hidden', opacity: '0'} : {}} className={styles.categoriesDropdown}>
        ...
        <section className={`${styles.centerFlex} ${styles.userBtns}`}>
          <span className={styles.centerFlex} style={{ marginRight: "50px" }}>
            <svg
